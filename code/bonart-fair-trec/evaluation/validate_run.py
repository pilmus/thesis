...
def validate(queries_file, query_sequence_file, run_file):
    queries = read_queries(queries_file)
    query_sequence = read_query_sequence(query_sequence_file)
    ...
    with open(run_file, "r") as fp:
        ...
        print(f"{run_file} is a valid run!")
...
def main():
    ...
    validate(args.queries, args.query_sequence_file,args.run_file)
