...
eel = glob.glob('/mnt/c/Users/maaik/Documents/thesis/app/evaluation/resources/2020/eval_results/*ERR.tsv')
...
for f in tqdm(eel):
    ...
    adddict = {'diff_mean': df.difference.mean(), 'disp_mean': df.disparity.mean(), 'rel_mean': df.relevance.mean()}
    for factor in factor_names:
        adddict[factor] = None
    fname = os.path.basename(f)
    fname = fname.replace('ac_controller_train10', 'ac')
    fname = fname.replace(
        '_TREC-Fair-Ranking-training-sample_-10-full-annotations-DocHLevel-mixed_group-qrels_ERR.tsv',
        '')
...
df.to_csv('/mnt/c/Users/maaik/Documents/thesis/app/evaluation/resources/2020/all_experiments_eel_ind.csv', index=False)
