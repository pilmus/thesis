...
for f in tqdm(eel):
    ...
    fname = fname.replace(
        '_TREC-Fair-Ranking-training-sample_-10-full-annotations-DocHLevel-mixed_group-qrels_EEL.tsv',
        '')
    ...
    eeldicts.append(adddict)


df = pd.DataFrame(eeldicts)
df.to_csv('/mnt/c/Users/maaik/Documents/thesis/app/evaluation/resources/2020/all_experiments_eel.csv', index=False)
