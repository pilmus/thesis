...
if __name__ == '__main__':
    ...
    for run in run_files:
        ...
        dicts = [{'seq_id': seq_id,
                  ...
                  'util-max': max(performance_all_utility[seq_id]),
                  'util-mean': mean(performance_all_utility[seq_id]),
                  'util-run': performance_team_utility[run][seq_id],
                  'unfairness-min': min(performance_all_fairness[seq_id]),
                  'unfairness-max': max(performance_all_fairness[seq_id]),
                  'unfairness-mean': mean(performance_all_fairness[seq_id]),
                  'unfairness-run': performance_team_fairness[run][seq_id]}
