...
SEQUENCE_EVAL = "resources/evaluation/2020/TREC-Fair-Ranking-eval-seq.tsv"
...
if training:
    deltr = DeltrFerraro(FEATURE_ENGINEER, training_group_file,
                         standardize=True)
...
# use this if you want to continue with previously trained models
    ...
    deltr = DeltrFerraro(FEATURE_ENGINEER, eval_group_file,
...
out = f"resources/evaluation/2020/rawruns/deltr_gammas_std_True-10.json"
