...
def clean_2020():
    ...
    dirty_training = 'resources/training/2020/TREC-Fair-Ranking-training-sample.json'
    clean_training = 'resources/training/2020/TREC-Fair-Ranking-training-sample-cleaned' \
                     '.json'
    ...
    es_df = pd.DataFrame(res['hits']['hits'])
    es_ids_set = set(es_df['_id'].to_list())
