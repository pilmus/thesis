...
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-0.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-1.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-2.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-3.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-4.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-5.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-6.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-7.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-8.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-avg-seed-9.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-0.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-1.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-2.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-3.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-4.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-5.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-6.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-7.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-8.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-dropzero-seed-9.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-0.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-1.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-2.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-3.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-4.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-5.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-6.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-7.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-8.json',
'submission_lambdamart-0-training-sequence-full.tsv-strat-None-seed-9.json',
...
'submission_lambdamart-training-sequence-full.tsv-seed-0.json',
    ]
    ...
    for run in run_files:
        submission = FairRankingSubmission(os.path.join(run_files_prefix, run))
    ...
    for run in run_files:
        with open('eval_results/%s/%s' % (args.group_definition, os.path.basename(run)), 'w') as f_out:
            f_out.write(
